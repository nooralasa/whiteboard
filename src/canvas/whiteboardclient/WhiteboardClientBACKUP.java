 ...
 */
public class WhiteboardClientBACKUP extends JPanel {
     ...
     */
    public WhiteboardClientBACKUP(int width, int height, String ipAddress, int portNumber) {
...
//        sidePanel = new SidePanel(250, height,this);
     ...
     */
    public void makeCanvas(final int x, final int y, final WhiteboardClientBACKUP canvas) {
...
//                window.add(buttonPanel, BorderLayout.SOUTH);
    ...
    public static void runWhiteboardClient(String ipAddress, int port){
        WhiteboardClientBACKUP client = new WhiteboardClientBACKUP(800,600, ipAddress, port);
